...
file_path = (
    "Modelling_data_19_customers.xlsx"  # Update with your actual file path
)
...
def get_distance_between_customers_by_id(customer_id_1, customer_id_2):
    ...
    if primary_customer_id_1 not in distance_df['KM'].values:
    ...
    distance_value = distance_df.loc[distance_df['KM'] == primary_customer_id_1, primary_customer_id_2].values[0]
