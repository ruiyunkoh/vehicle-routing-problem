# -*- coding: utf-8 -*-
"""Show Schneider (No Split Deliveries/No Truck Limit).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1fvoNA2Ngz0lbALIyEw2RIdaG0kmbiFV9
"""

# -*- coding: utf-8 -*-
"""Final Final Version with everything working (except for splitting deliveries and driver break)

Automatically generated by Colab

Original file is located at
    https://colab.research.google.com/drive/1LEhQsufCnH9U_9bceHwzPL4_AEZdXYZ3
"""
...
# -*- coding: utf-8 -*-
"""VRP_SOLVER_ORTOOLS_(TW_UNLOADING_TIME_WORKING).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1boUcdQudgYD2CBugLvDj0eA80erPyeYy
"""
import os
import pandas as pd
import numpy as np
...
trucks_df = pd.read_excel(xls, "Trucks", index_col=0, engine="openpyxl")
...
per_km_rate = parameters_df.iloc[0, 0]  # e.g., value from cell B2 ($/km)
speed_fast = parameters_df.iloc[1, 0]  # e.g., value from cell B3 (km/h)
speed_slow = parameters_df.iloc[2, 0]  # e.g., value from cell B3 (km/h)
base_unloading_time = parameters_df.iloc[3, 0]  # e.g., value from cell B5 (min)
unloading_time_scale_factor = parameters_df.iloc[4, 0]  # e.g., value from cell B6 (min)
# lunch_break = parameters_df.iloc[5, 0]  # e.g., value from cell B6 (min)
lunch_break = 30
"""
